...
'''Get the file frl_apartment_i_coloredMesh_with_IDs.ply, i.e., the point cloud with a visible segmentation (given by the ground truth) of a scene from the Replica dataset
...
path_meshSemantics = os.path.join(basePath, frl_apartment, "Segmentation") # folder containing the mesh_semantic.ply_i.ply
...
path_save_objectsJSON = os.path.join(basePath, frl_apartment, "SGAligner/objects.json")
...
# Save coloredMesh_with_IDs.ply.ply 
#
...
output_ply = os.path.join(path_meshSemantics, frl_apartment + "_coloredMesh_with_IDs.ply")
