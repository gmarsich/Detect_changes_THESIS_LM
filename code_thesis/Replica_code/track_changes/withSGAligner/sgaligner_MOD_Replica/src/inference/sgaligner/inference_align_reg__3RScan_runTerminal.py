...
if __name__ == '__main__':
    main() # GAIA in the terminal you should change to the src folder and then write something like: python inference/sgaligner/inference_align_reg.py --config /local/home/gmarsich/Desktop/Thesis/0Code_playground/SceneGraphs_changes_Replica/sgaligner_MOD_3RScan/configs/scan3r/scan3r_ground_truth.yaml --snapshot /local/home/gmarsich/Desktop/weights+files/gat-point-epoch-50.pth.tar