...
def update_changes(old_SceneGraph, new_SceneGraph, list_newID_added, list_oldID_removed, dict_oldIDnewID_moved, dict_oldIDnewID_still):
    ...
    for objectID in deepcopy_old_SceneGraph.nodes:
        ...
        elif objectID in dict_oldIDnewID_moved:
        ...
        elif objectID in dict_oldIDnewID_still:
    ...
    for objectID in deepcopy_new_SceneGraph.nodes:
        ...
        elif objectID in dict_oldIDnewID_moved.values():
        ...
        elif objectID in dict_oldIDnewID_still.values():
...
if __name__ == '__main__':
    ...
    # list_IDs_0 = ['10', '4', '71', '77', '45', '120', '100', '102']
    # list_IDs_1 = ['27', '103', '136', '34', '127', '89', '100', '102']
