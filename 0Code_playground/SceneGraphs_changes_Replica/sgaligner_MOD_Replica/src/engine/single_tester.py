...
class SingleTester(BaseTester):
    ...
    def run(self):
        ...
        for iteration, data_dict in pbar: 
            ...
            # eval step
            results_dict = self.eval_step(self.iteration, data_dict, output_dict) # GAIA core function, where results are computed; "original" data and embeddings are both used
