...
def update_config(cfg, filename, ensure_dir=True):
    cfg.defrost()
    cfg.merge_from_file(filename) # GAIA copy the configs provided in the scan3r_ground_truth.yaml file
    
    if ensure_dir: # GAIA add some more things, in particular paths to directories that will be used or created
