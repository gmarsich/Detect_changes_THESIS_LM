...
class ReplicaDataset(data.Dataset):
    def __init__(self, cfg, split): # split will be 'val'
        self.split = split
    ...
    def __getitem__(self, idx):
        ...
        src_data_dict = common.load_pkl_data(osp.join(self.scans_files_dir, '{}/data/{}.pkl'.format(self.mode, src_scan_id))) # GAIA comes from the pkl file
