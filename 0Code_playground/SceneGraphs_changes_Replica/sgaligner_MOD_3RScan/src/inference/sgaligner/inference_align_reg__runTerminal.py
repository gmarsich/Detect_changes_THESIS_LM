...
# def main(): # GAIA modified main, but does not work properly (the snapshot is not carried in the right way in the code)
#     args_list = [
#         '--config', '/local/home/gmarsich/Desktop/sgaligner_MOD_3RScan/configs/scan3r/scan3r_ground_truth.yaml',
#         '--snapshot', '/local/home/gmarsich/Desktop/weights+files/gat-point-rel-attr-epoch-50.pth.tar',
#         # '--test_epoch', '10',
#         # '--test_iter', '1000',
...
if __name__ == '__main__':
    main() # GAIA in the terminal you should write something like: python inference/sgaligner/inference_align_reg.py --config /local/home/gmarsich/Desktop/sgaligner_MOD_3RScan/configs/scan3r/scan3r_ground_truth.yaml --snapshot /local/home/gmarsich/Desktop/weights+files/gat-point-epoch-50.pth.tar